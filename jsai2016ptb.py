...
for i in six.moves.range(jump * n_epoch):
    ...
    if (i + 1) % jump == 0:
        ...
        serializers.save_npz('jsai2016ptb_%s.model' % (strtime), model)

        print('save the optimizer')
        serializers.save_npz('jsai2016pbt_%s.state' % (strtime), optimizer)
...
serializers.save_npz('jsai2016ptb_%s.model' % (strtime), model)
print('save the optimizer')
serializers.save_npz('jsai2016ptb_%s.state' % (strtime), optimizer)
